	<section id="projects">
		...
		<?php
			...
			*/
			...
			// FilterNav output
			mellow_filter_nav( 'sngrs_sngrs_tax', $ttrust_config['page_skills'] );

			// Get the projects WP_Query object
			$projects = mellow_posts_setup( 'sngrs_sngrs_cpt', 200, $ttrust_config['page_skills'] );
			...
			<div id="projects"<?php echo $masonry_class; ?>>
				<div class="thumbs clearfix">
					<?php  while ( $projects->have_posts() ) : $projects->the_post();
						...
						$skills = mellow_get_tax( $post, 'sngrs_sngrs_tax' );
